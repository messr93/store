                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table m-0">
                            ...
                            <tbody>
                            <tr>
                                <td><a href="{{asset('backend')}}/pages/examples/invoice.html">OR9842</a></td>
                            ...
                            <tr>
                                <td><a href="{{asset('backend')}}/pages/examples/invoice.html">OR1848</a></td>
                            ...
                            <tr>
                                <td><a href="{{asset('backend')}}/pages/examples/invoice.html">OR7429</a></td>
                                <td>iPhone 6 Plus</td>
