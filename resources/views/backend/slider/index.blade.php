...
@section('content')
    <a href="{{route('admin.slider.create')}}" class="btn btn-success my-3"><i class="fa fa-plus"></i> {{ __('backend.Add slider') }}</a>
    ...
    <script>
        $(document).ready(function(){
            ...
            var table = $('#slider-table').DataTable({
               processing: true,
               serverSide: true,
               ajax: '{!! route('admin.slider.allData') !!}',
               columns:[
            ...
            $(document).on('click', '.delete-btn', function(e){
               ...
               $('#deletion_modal_title').text( '{{__('backend.Slider deletion')}}' );
