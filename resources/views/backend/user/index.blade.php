...
@section('content')
    <a href="{{ route('admin.user.create') }}" class="btn btn-success my-3"><i class="fa fa-plus"></i>{{ __('backend.Add user') }}</a>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '.delete-btn', function(e){
                ...
                $('#deletion_modal_title').text( '{{__('backend.User deletion')}}' );
